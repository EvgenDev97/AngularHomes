...
export class HousingService {
  private housingLocationList = locations;
  private _filteredLocationList = locations;

  constructor() {}

  get filteredLocationList() {
    return this._filteredLocationList;
  }
  ...
  filterResults(text: string) {
    ...
    this._filteredLocationList = this.housingLocationList.filter(
      (housingLocation) =>
